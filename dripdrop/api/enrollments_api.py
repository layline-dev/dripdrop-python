...
class EnrollmentsApi:
    ...
    def enrollments_create(
        ...
        _param = self._enrollments_create_serialize(
    ...
    @validate_call
    def enrollments_create_with_http_info(
        self,
        public_flow_enrollment: PublicFlowEnrollment,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def enrollments_create_without_preload_content(
        self,
        public_flow_enrollment: PublicFlowEnrollment,
        _request_timeout: Union[
            None,
    ...
    def _enrollments_create_serialize(
        self,
    ...
    def enrollments_destroy(
        ...
        _param = self._enrollments_destroy_serialize(
            uuid=uuid,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def enrollments_destroy_with_http_info(
        self,
        uuid: UUID,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def enrollments_destroy_without_preload_content(
        self,
        uuid: UUID,
        _request_timeout: Union[
            None,
    ...
    def _enrollments_destroy_serialize(
        self,
        uuid,
        _request_auth,
        _content_type,
    ...
    def enrollments_list(
        ...
        _param = self._enrollments_list_serialize(
            ordering=ordering,
            page=page,
            page_size=page_size,
            _request_auth=_request_auth,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "PaginatedPublicFlowEnrollmentList",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def enrollments_list_with_http_info(
        self,
        ordering: Annotated[Optional[StrictStr], Field(description="Which field to use when ordering the results.")] = None,
        page: Annotated[Optional[StrictInt], Field(description="A page number within the paginated result set.")] = None,
        page_size: Annotated[Optional[StrictInt], Field(description="Number of results to return per page.")] = None,
    ...
    @validate_call
    def enrollments_list_without_preload_content(
        self,
        ordering: Annotated[Optional[StrictStr], Field(description="Which field to use when ordering the results.")] = None,
        page: Annotated[Optional[StrictInt], Field(description="A page number within the paginated result set.")] = None,
        page_size: Annotated[Optional[StrictInt], Field(description="Number of results to return per page.")] = None,
    ...
    def _enrollments_list_serialize(
        self,
        ordering,
        page,
        page_size,
