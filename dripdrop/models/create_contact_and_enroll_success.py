...
class CreateContactAndEnrollSuccess(BaseModel):
    """
    CreateContactAndEnrollSuccess
    """ # noqa: E501
    message: StrictStr
    contact: Contact
    enrollment: PublicFlowEnrollment
    __properties: ClassVar[List[str]] = ["message", "contact", "enrollment"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "enrollment": PublicFlowEnrollment.from_dict(obj["enrollment"]) if obj.get("enrollment") is not None else None
        })
        return _obj
