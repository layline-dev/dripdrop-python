...
class PublicContactBulkCreateRequest(BaseModel):
    """
    PublicContactBulkCreateRequest
    """ # noqa: E501
    contacts: List[Contact]
    on_duplicate: Optional[OnDuplicateEnum] = None
    __properties: ClassVar[List[str]] = ["contacts", "on_duplicate"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "on_duplicate": obj.get("on_duplicate")
        })
        return _obj
