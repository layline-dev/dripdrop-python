...
class PublicContactDuplicatePreviewResponse(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "resolutions": [ImportResolution.from_dict(_item) for _item in obj["resolutions"]] if obj.get("resolutions") is not None else None
        })
        return _obj
