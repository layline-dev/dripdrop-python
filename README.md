...
------------ | ------------- | ------------- | -------------
*ContactsApi* | [**bulk_create**](docs/ContactsApi.md#bulk_create) | **POST** /v1/contacts/bulk/ | Bulk create contacts
...
*ContactsApi* | [**duplicates_create**](docs/ContactsApi.md#duplicates_create) | **POST** /v1/contacts/duplicates/ | Preview duplicates for incoming contacts
*ContactsApi* | [**duplicates_list**](docs/ContactsApi.md#duplicates_list) | **GET** /v1/contacts/duplicates/ | List duplicate contact clusters
...
*EnrollmentsApi* | [**partial_update**](docs/EnrollmentsApi.md#partial_update) | **PATCH** /v1/enrollments/{uuid}/ | Patch an enrollment
*EnrollmentsApi* | [**update**](docs/EnrollmentsApi.md#update) | **PUT** /v1/enrollments/{uuid}/ | Update an enrollment
...
## Documentation For Models
 ...
 - [PatchedPublicFlowEnrollment](docs/PatchedPublicFlowEnrollment.md)
